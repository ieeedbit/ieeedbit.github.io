    ...
    $.ajax({
        ...
        success: function(result) {
            ...
            for (myEvent in events) {
                ...
                htmlString += `<a href="/`+events[myEvent].title+`.html" class='name'><strong>` + events[myEvent].title + `</strong></a></div><div class='event-expand'><i class='fa fa-plus'></i></div></div></div>`;
